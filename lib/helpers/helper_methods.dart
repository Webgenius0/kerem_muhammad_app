...
import 'package:kerem_muhammad_app/common_widgets/exit_button.dart';
import 'package:kerem_muhammad_app/constants/app_constants.dart';
import 'package:kerem_muhammad_app/helpers/di.dart';
import 'package:kerem_muhammad_app/helpers/toast.dart';
...
Future<void> setInitValue() async {
  ...
  await appData.writeIfNull(kKeySelectedWaterML, 100);
  await appData.writeIfNull(kKeyBmiScore, 0.0);
