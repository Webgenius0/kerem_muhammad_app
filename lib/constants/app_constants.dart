...
const String kKeySelectedWaterML = 'k_key_selected_water_ml';
const String kKeyBmiScore = 'k_key_bmi_score';
...
const String kKeyPhone = 'kKeyPhone';
const String kKeyGender = 'kKeyGender';
...
const String otpVerifyToken = 'otpVerifyToken';
const String kKeyAvater = 'kKeyAvater';
const String kKeyotpVerifyToken = 'verify_token';
