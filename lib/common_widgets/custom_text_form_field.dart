  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        style:
            style ??
            TextFontStyle.txtfontstyle26w600cFFFFF.copyWith(fontSize: 16.sp),
        ...
        decoration: InputDecoration(
          counterText: '', // This hides the max length text
          filled: true,
          ...
          hintText: hintText,
          hintStyle: hintTextStyle ?? TextFontStyle.txtfontstyle26w600cFFFFF,
          labelText: labelText,
          ...
          focusedErrorBorder: const UnderlineInputBorder(
            borderSide: BorderSide(color: Colors.red), // Bottom border
          ),
          focusedBorder:
              focusedBorder ??
              const UnderlineInputBorder(
